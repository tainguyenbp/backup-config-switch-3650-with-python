...
# vault kv put secret/cisco_ios/host host='192.168.1.1'
# vault kv put secret/cisco_ios/username username=tainguyenbp
# vault kv put secret/cisco_ios/password password='tainn@passw0rd'
# vault kv put secret/cisco_ios/port port=22
# vault kv put secret/cisco_ios/secret secret=passw0rd

client = hvac.Client(url=os.environ['VAULT_ADDR'], token=os.environ['VAULT_TOKEN'])


read_response_host = client.secrets.kv.v2.read_secret_version(path='cisco_ios/host')
read_response_username = client.secrets.kv.v2.read_secret_version(path='cisco_ios/username')
read_response_password = client.secrets.kv.v2.read_secret_version(path='cisco_ios/password')
read_response_port= client.secrets.kv.v2.read_secret_version(path='cisco_ios/port')
read_response_secret= client.secrets.kv.v2.read_secret_version(path='cisco_ios/secret')
